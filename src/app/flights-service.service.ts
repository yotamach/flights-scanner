...
export class FlightsServiceService {
  ...
  constructor() {
    this.flightsList.push({
      ...
      returnDate: new Date('2020/10/10 06:00'),
      numOfConnections: 1,
      price: 400
    }, {
      fromLocation: 'UAE',
      ...
      returnDate: new Date('2020/09/12 13:30'),
      numOfConnections: 2,
      price: 100
    }, {
      fromLocation: 'Canada',
      ...
      returnDate: new Date('2021/01/01 13:10'),
      numOfConnections: 1,
      price: 1200
    }, {
      fromLocation: 'Mexico',
      ...
      returnDate: new Date('2021/01/09 17:40'),
      numOfConnections: 2,
      price: 1450
    }, {
      fromLocation: 'Brasil',
      ...
      returnDate: new Date('2020/11/04 13:30'),
      numOfConnections: 1,
      price: 1100
    }, {
      fromLocation: 'France',
      ...
      returnDate: new Date('2020/10/22 18:35'),
      numOfConnections: 0,
      price: 200
    }, {
      ...
      returnDate: new Date('2020/11/09 20:55'),
      numOfConnections: 0,
      price: 350
    }, {
      fromLocation: 'Russia',
      ...
      returnDate: new Date('2020/02/02 14:45'),
      numOfConnections: 1,
      price: 900
    }, {
      fromLocation: 'India',
      ...
      returnDate: new Date('2021/03/22 13:30'),
      numOfConnections: 1,
      price: 850
    }, {
      fromLocation: 'India',
      ...
      returnDate: new Date('2021/11/26 13:30'),
      numOfConnections: 1,
      price: 450
    }, {
      fromLocation: 'Spain',
      ...
      returnDate: new Date('2021/04/02 16:30'),
      numOfConnections: 2,
      price: 150
    }, {
      fromLocation: 'Spain',
      ...
      returnDate: new Date('2020/11/02 15:30'),
      numOfConnections: 0,
      price: 250
    }, {
      fromLocation: 'United Kingdom',
      ...
      returnDate: new Date('2020/12/23 16:30'),
      numOfConnections: 3,
      price: 1500
    }, {
      fromLocation: 'Iran',
      ...
      returnDate: new Date('2021/09/12 13:30'),
      numOfConnections: 0,
      price: 200
    }, {
      fromLocation: 'Greece',
      ...
      returnDate: new Date('2021/05/12 13:30'),
      numOfConnections: 0,
      price: 120
    }, {
      ...
      returnDate: new Date('2021/07/13 13:30'),
      numOfConnections: 2,
      price: 1250
    }, {
      ...
      returnDate: new Date('2020/11/13 13:30'),
      numOfConnections: 1,
      price: 950
    });
  }
  ...
  searchFlights(
    ...
    this.ObservableList.next(filteredResults);
  }
}
